...
\item
\claim0
$\forall j\prec i$, $\M^{I(i)}_{\str{\U}}\models U_j\cup T_j$.

\item
For any such $j$, by transitivity of $\prec$, since $I(i)$ is above $i$,
$I(i)$ is above $j$. Therefore the claim is immediate by ($*$).
