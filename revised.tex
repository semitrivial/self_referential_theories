...
For the remainder of the section, fix a strict r.e.~well-founded
partial-order $\prec$ on $\omega$.
...
\begin{convention}
For any particular $i\in\omega$, by convention, we will write $I(i)$ for
a stratifier-set with the property that for each $j\in\indices(I(i))$,
$i\prec j$.
\end{convention}
