...
Since $T_j$ is r.e., by the $S$-$m$-$n$ theorem there is some $n$
such that $W_n=\{m\,:\,T_j\models \phi(x|\overline{m})(x_1|\overline{s(x_1)})
...
In order to to fulfil the second promise
