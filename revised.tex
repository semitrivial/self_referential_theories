...
\begin{enumerate}
    ...
    \item
    $[S]_i$ where $S$ is any r.e.\ set of true arithmetic sentences.
    \item
    $[\mbox{$j$-SMT}]_i$.
...
Comparing the above-mentioned statifiable-r.e.-generic families with the
families from Section \ref{closedregenericblocks}, we see that the
...
\begin{enumerate}
    ...
    (Contrast Lemmas
    \ref{secondutilbagdeduction} and \ref{firstutilbagdeduction})
    \item (Finish this)
\end{enumerate}
For now, it is an open question whether ...
