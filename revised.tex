...
$\M_{\str{\U}}^{I(i)}\models U_i\cup T_i$.
    ...
    $\M_{\str{\U}}^{I(i)}$ satisfies axioms stating that $\Prr\alpha i\phi\rightarrow\phi$.
    This, at long last, is where we will use induction on $\alpha$ (enabled by our careful
