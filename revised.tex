...
That $\M_{\U}$ satisfies Assigned Validity and $j$-Validity is as in (3).
By (1), $\M_{\U}$ satisfies $j$-Deduction.
...
$\Pr j \phi$ ($\phi\in T_j$).  Right away $\M_{\U}\models \T$
...
\item
(7)
By (5), $\M^{I(i)}\models(\mbox{$i$-Assigned Strativalidity})
\cup (\mbox{$i$-Strativalidity})$ for every computable stratifier-set
$I(i)$ above $i$.
By (1), $\M^{I(i)}\models \mbox{$i$-Stratideduction}$ for every computable
stratifier-set $I(i)$ above $i$.
...
This means $U^-_i\models \phi^s$.
By compactness, there are $\sigma_1,\ldots,\sigma_k\in U_i$
such that $\sigma^-_1\rightarrow\cdots\rightarrow\sigma^-_k\rightarrow\phi^s$
is valid.
Let $\alpha>\onset(\sigma^-_1\rightarrow\cdots\rightarrow\sigma^-_k\rightarrow\phi^s)$.
Since $U_i$ contains $i$-Strativalidity, in particular
$U^-_i$ contains $(\Prr\alpha i (\sigma^-_1\rightarrow\cdots\rightarrow\sigma^-_k\rightarrow\phi^s))^-$.
In other words, $U^-_i$ contains
$\Pr i(\sigma^-_1\rightarrow\cdots\rightarrow\sigma^-_k\rightarrow\phi^s)$.
By repeated application of $(\mbox{$i$-Stratideduction})^-$ contained in
$U^-_i$,
$U^-_i\models \Pr i\sigma^-_1\rightarrow\cdots\rightarrow\Pr i\sigma^-_k\rightarrow
\Pr i\phi^s$.
Since $\U$ is straticlosed, it follows that $U_i$ contains
$\Prr\alpha i \sigma_1,\ldots,\Prr\alpha i \sigma_k$.
Thus $U^-_i$ contains $\Pr i\sigma^-_1,\ldots,\Pr i\sigma^-_k$,
so $U^-_i\models \Pr i\phi^s$.
Thus $\M\models \Pr i\Pr i\phi[s]$,
and since $\M$ and $\M^{J(j)}$ agree on $\Pr i$, this shows
...
so $\beta>\alpha$.
By Part 1 of Proof Stratification (Theorem \ref{proofstratification}),
...
\item
(8)
Similar to part 4 of Lemma \ref{firstgrabbag}.  Use
