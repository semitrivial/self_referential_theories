...
operators in $U_i$ is $U^-_i=T_i$.
The intended interpretation
of $\Prr \alpha i \phi[s]$ will be that
...
$U_i\cap(\epsilon_0\cdot m)$ and $U_i\cap(\epsilon_0\cdot n)$
have essentially the same consequences, except for the superscripts
...
This would have the side effect that for any $\alpha'>\alpha$,
$U_i\cap\alpha'\models\Prr \alpha i (1+1=2)$,
so that $\Prr {\alpha'} i \Prr \alpha i (1+1=2)$
...
$U_i$ contain
\[\Prr {\alpha_0} i\phi \rightarrow \Prr {\alpha'} i \Prr {\alpha} i \phi\]
(whenever $\alpha'>\alpha$).
The reason for the $\alpha'$ is as follows.
