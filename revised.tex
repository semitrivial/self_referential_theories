...
For any (G\"odel number of an) r.e.\ partial order $\omega$
...
\begin{itemize}
    ...
    if $\T^0$ is closed-r.e.-generic, then there is some $n\in\mathbb N$
    such that $\T(n)$ is true, where $\T(n)=(T_i(n))_{i\in\omega}$ is the smallest
