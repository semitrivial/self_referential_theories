...
$\M^{I(i)}_{\hat\U}\models \ucl{\Pr j(\phi\rightarrow\psi)
\rightarrow\Pr j\phi\rightarrow\Pr j\psi}$.

Let $s$ be an assignment and assume
$\M^{I(i)}_{\hat\U}\models \Pr j(\phi\rightarrow\psi)[s]$
and $\M^{I(i)}_{\hat\U}\models\Pr j\phi[s]$.
Since $I(i)$ is above $i$, $\M^{I(i)}_{\hat\U}$ and $\M_{\hat\U}$
agree on $\Pr j$.
By definition of $\M_{\hat\U}$, $U^-_j\models\phi^s\rightarrow\psi^s$
and $U^-_j\models\phi^s$, thus $U^-_j\models\psi^s$, so
$\M_{\hat\U}\models \Pr j\psi[s]$ and thus so does $\M^{I(i)}_{\hat\U}$.

\item
(3) Let $I(i)$ be any computable stratifier-set above $i$,
we must show
$\M^{I(i)}_{\hat\U}\models \ucl{\Pr j(\phi\rightarrow\psi)\rightarrow \Pr j\phi\rightarrow \Pr j(\psi\wedge(\phi\vee\neg\phi))}$.
Let $s$ be an assignment and assume $\M^{I(i)}_{\hat\U}\models \Pr j(\phi\rightarrow\psi)[s]$
and $\M^{I(i)}_{\hat\U}\models\Pr j\phi[s]$.
If $j\not\in\indices(I(i))$, then $\M^{I(i)}_{\hat\U}$ and $\M_{\hat\U}$
...
$\M^{I(i)}_{\hat\U}$ and $\M^+_{\hat\U}$ agree on $\Pr j$.
%
...
\item
(6)
By (4), $\M^{I(i)}_{\hat\U}\models\mbox{$i$-Assigned Strativalidity}$
for every computable stratifier-set $I(i)$ above $i$.
Let $I(j)$ be a computable stratifier-set above $j$, we must
show $\M^{I(j)}_{\hat\U}\models \mbox{$i$-Validity}$.
...
\case1
$i\not\in\indices(I(j))$.
Then $\M^{I(j)}_{\hat\U}$ and $\M_{\hat\U}$ agree on $\Pr i$.
...
thus $\M_{\hat\U}\models \Pr i\phi[s]$, and so does $\M^{I(j)}_{\hat\U}$.

\item
\case2
$i\in\indices(I(j))$.
Thus $j\prec i$ and we can write $I(j)=I_0\cup\{\bullet^+\}$
for some computable $i$-stratifier $\bullet^+$.
By Lemma \ref{decomposingMtotheI}, $\M^{I(j)}_{\hat\U}$ and
$\M^+_{\hat\U}$ agree on $\Pr i$.
...
Since $\M^{I(j)}_{\hat\U}$ and $\M^+_{\hat\U}$ agree on $\Pr i$,
$\M^{I(j)}_{\hat\U}\models\Pr i\phi[s]$.
